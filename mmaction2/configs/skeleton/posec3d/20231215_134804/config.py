ann_file = '/Users/fukunagaatsushi/src/github.com/open-mmlab/mmaction2/my_study/data/custom_dataset/custom_dataset_train.pkl'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/Users/fukunagaatsushi/src/github.com/open-mmlab/mmaction2/my_study/data/custom_dataset/custom_dataset_train.pkl',
        pipeline=[
            dict(
                clip_len=48,
                num_clips=10,
...
work_dir = './configs/skeleton/posec3d'
