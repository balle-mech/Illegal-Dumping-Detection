ann_file = '/Users/fukunagaatsushi/src/github.com/a2c6201/Illegal-Dumping-Detection/mmaction2/my_study/data/pkl_dataset/custom_dataset/custom_dataset.pkl'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/Users/fukunagaatsushi/src/github.com/a2c6201/Illegal-Dumping-Detection/mmaction2/my_study/data/pkl_dataset/custom_dataset/custom_dataset.pkl',
        pipeline=[
            dict(
                clip_len=48,
                num_clips=10,
...
work_dir = './configs/skeleton/posec3d/keypoint'
