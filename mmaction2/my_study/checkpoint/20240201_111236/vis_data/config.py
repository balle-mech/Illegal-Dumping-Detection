ann_file = '/content/drive/MyDrive/mmaction2/my_study/data/pkl/custom_dataset/custom_dataset_10.pkl'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/content/drive/MyDrive/mmaction2/my_study/data/pkl/custom_dataset/custom_dataset_10.pkl',
        pipeline=[
            dict(
                clip_len=48,
                num_clips=10,
