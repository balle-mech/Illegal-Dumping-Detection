ann_file = '/content/drive/MyDrive/mmaction2/my_study/data/pkl/custom_dataset/custom_dataset_30.pkl'
...
load_from = './my_study/checkpoint/custom_30/30_best_acc_top1_epoch_13.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/content/drive/MyDrive/mmaction2/my_study/data/pkl/custom_dataset/custom_dataset_30.pkl',
        pipeline=[
            dict(
                clip_len=48,
                num_clips=10,
...
test_evaluator = [
    ...
    dict(
        out_file_path=
        './my_study/data/pkl/custom_dataset/custom_dataset_30.pkl',
        type='DumpResults'),
]
test_pipeline = [
    dict(
...
work_dir = './my_study/checkpoint/custom_30'
