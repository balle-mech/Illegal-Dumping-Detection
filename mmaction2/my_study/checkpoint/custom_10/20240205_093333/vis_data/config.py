...
load_from = './my_study/checkpoint/custom_10/10_best_acc_top1_epoch_4.pth'
log_level = 'INFO'
...
test_evaluator = [
    ...
    dict(
        out_file_path=
        './my_study/data/pkl/custom_dataset/custom_dataset_10.pkl',
        type='DumpResults'),
]
test_pipeline = [
    dict(
...
work_dir = './my_study/checkpoint/custom_10'
