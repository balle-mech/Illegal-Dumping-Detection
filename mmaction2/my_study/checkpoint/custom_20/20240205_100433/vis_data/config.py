...
load_from = './my_study/checkpoint/custom_20/20_best_acc_top1_epoch.pth'
log_level = 'INFO'
...
test_evaluator = [
    ...
    dict(
        out_file_path=
        './my_study/data/pkl/custom_dataset/custom_dataset_20.pkl',
        type='DumpResults'),
]
test_pipeline = [
    dict(
...
work_dir = './my_study/checkpoint/custom_20'
